...
class CLexer(object):
    ...
    def __init__(self, error_func, on_lbrace_func, on_rbrace_func,
        ...
        self.comment_cond_pattern = re.compile(r'[ \t]*\#cond\W')
        self.comment_action_pattern = re.compile(r'[ \t]*\#action\W')
    ...
    # other statement start with #
    def t_ppother_NEWLINE(self, t):
        r'\n'
        t.lexer.lineno += 1
        t.lexer.begin('INITIAL')
    ...
    def t_ppother_STR(self, t):
        '.+'
        pass

    def t_ppother_error(self, t):
        self._error('invalid #pragma directive', t)
    ...
    def t_CPP_COMMENT2(self, t):
        r'[ \t]*//'
        if self.comment_cond_pattern.match(t.lexer.lexdata, pos=t.lexer.lexpos):
            t.lexer.begin('ccond')
        elif self.comment_action_pattern.match(t.lexer.lexdata, pos=t.lexer.lexpos):
            t.lexer.begin('caction')
        else:
            t.lexer.begin('ccomment')
    
    def t_ccond_caction_ccomment_NEWLINE(self, t):
        r'\n'
        t.lexer.lineno += 1
        t.lexer.begin('INITIAL')

    def t_ccond_COMMENTCOND(self, t):
        r'\#cond'
        return t
    
    def t_caction_COMMENTACTION(self, t):
        r'\#action'
        return t
    

    t_ccond_caction_ccomment_ignore = ' \t'

    def t_ccond_caction_STR(self, t):
        r'.+'
        t.type = 'COMMENTSTR'
        return t
    
    def t_ccomment_STR(self, t):
        r'.+'
        pass

    def t_ccond_caction_ccomment_error(self, t):
        self._error('invalid #pragma directive', t)
